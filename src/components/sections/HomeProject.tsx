...
const HomeProject = () => {
    ...
    },
    {
        ...
        desc: "An online peer-to-peer marketplace for stock images, built with Stripe integration. Where, users can buy and sell images directly with each other, with features such as account creation, profile editing, buying and creating posts, and more",
